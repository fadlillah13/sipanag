<div class="register-box ">
	<div class="card">
		<div class="card-body register-card-body">
			<img src="<?= base_url(); ?>assets/img/logo-td.png" class="brand-image mx-auto d-block mb-2 mt-1 " width="60" height="70">
			<h3 class=" text-bold text-center mb-4">DAFTAR <span class="text-primary">SIPANAG</span> </h3>
			<hr>
