<div class="login-box ">
	<div class="card rounded">
		<div class="card-body login-card-body">
			<img src="<?= base_url(); ?>assets/img/logo-td.png" class="brand-image mx-auto d-block mb-2 " width="60" height="70">
			<h3 class=" text-bold text-center mb-2">MASUK <span class="text-primary">SIPANAG</span> </h3>
			<hr>
