<nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
	<a class="navbar-brand" href="#">
		<img src="<?= base_url(); ?>assets/img/logo-td.png" class="brand-image mr-2 mb-1" width="30px" height="30px" style="opacity: .8">
		<strong>SIPANAG</strong> </a>
	<button class="btn btn-link btn-sm order-1 order-lg-0 mb-1" id="sidebarToggle" href="#"><i class="fas fa-bars bg-grey-800"></i></button>
	<h5 class=" text-light ml-3"><strong>SISTEM PELAYANAN SURAT NAGARI GUGUAK MALALO</strong> </h5>
	<!-- Navbar-->
